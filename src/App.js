...
function App() {
  ...
  const fetchPowerStatus = useCallback(async () => {
    try {
      const res = await fetch("https://jason-super-expensive-laughing.trycloudflare.com/power-status");
  ...
  const fetchBatteryData = useCallback(async () => {
    try {
      const res = await fetch("https://jason-super-expensive-laughing.trycloudflare.com/battery-percentage");
      const json = await res.json();
  ...
  const fetchMemoryData = useCallback(async () => {
    try {
      const res = await fetch("https://jason-super-expensive-laughing.trycloudflare.com/memory-usage");
      const json = await res.json();
      setMemoryData(json);
      setLastUpdated(getTime());
    } catch (err) {
  ...
  const fetchNetworkSpeed = useCallback(async () => {
    try {
      const res = await fetch("https://jason-super-expensive-laughing.trycloudflare.com/network-speed");
      const json = await res.json();
